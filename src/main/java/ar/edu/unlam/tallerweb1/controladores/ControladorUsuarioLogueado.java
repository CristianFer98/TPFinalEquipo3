...
public class ControladorUsuarioLogueado {
	...
	public ModelAndView reservarTurno(@RequestParam("idTurno") Integer idTurno,
		...
		// Pagos pago=new Pagos(paymentId, turnoNuevo.getClienteAsignado(), turnoNuevo ,turnoNuevo.getValorFinal().floatValue());
	...
	public ModelAndView verMisTurnos (HttpServletRequest req, TurnoMedico turno) {
		...
		TurnoMedico turnoCancel =  turno;
		model.put("turnoCancel", turnoCancel);
	...
	public ModelAndView reservarTurno( @RequestParam("status") String status,
	...
	private int IdUser(Integer id, Integer idUser) {
		// TODO Auto-generated method stub
		return 0;
	}
	
//	@RequestMapping(path = "devolucionDinero", method= RequestMethod.GET)
//	public ModelAndView devolucionDinero(@RequestParam ("idPago") Integer id) {
//		Pagos pagoADevolver = servicioPagos.getPagoByID(id);
//		
//		pagoADevolver.
//		
