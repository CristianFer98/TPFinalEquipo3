...
public class ControladorAmbulancias {
	...
	public ModelAndView mostrarFormularioGestionAmbulancia(HttpServletRequest req) {
	...
	public ModelAndView mostrarSolucitudDeAmbulanciaEnCurso(
			@ModelAttribute("datosSolicitudAmbulancia") DatosSolicitudAmbulancia solicitud, HttpServletRequest req) {
	...
	public ModelAndView ocuparAmbulancia(@RequestParam("patente") String patenteAmbulancia, HttpServletRequest req) {
	...
	public ModelAndView eliminarAmbulancia(@RequestParam("patente") String patenteAmbulancia, HttpServletRequest req) {
		if (req.getSession().getAttribute("idUsuario") != null) {
