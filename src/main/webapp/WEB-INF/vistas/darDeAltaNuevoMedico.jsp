...
<main>
	...
	<div class="registro">
		...
		<form action="Registrarse" method="POST"
			...
			modelAttribute="DatosRegistroUsuario">

			<div style="display: flex; flex-direction: column">
				<h4>Ingrese los datos para registrar a un Medico</h4>

				<input type="text" path="email" name="email" id="contrasenia2"
					placeholder="Ingrese el Email" class="inicioSesion_inputs" required>
				<input type="text" path="nombre" name="nombre" id="nombre"
					placeholder="Ingrese su Nombre" class="inicioSesion_inputs"
					required> <input type="date" path="edad" name="edad"
					id="edad" placeholder="Ingrese su Edad" class="inicioSesion_inputs"
					required> <input type="password" path="contrasenia1"
					name="contrasenia1" id="contrasenia2" placeholder="Ingrese Clave"
					...
					name="numeroDeTipoDeUsuario" value="2">
			</div>
