...
<body>
    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <form:form action="registrarse" method="POST" modelAttribute="DatosRegistroUsuarioComun"><!-- Aca no son los datos del login sino de un usuario nuevo. 
        																				El cual tiene otras caracteristicas
        																				es un metodo POST porque hace cambios  -->
            <h3 class="form-signin-heading">Registro</h3>
            <hr class="colorgraph"><br>

            Ingrese su email: <form:input path="email" name="numero1" type="number" class="form-control" /><!-- Los atributos de la clase datosRegistro -->
           
            Ingrese una clave: <form:input path="contrasenia1" name="numero2" type="number" class="form-control"/>
            
            Repita su clave: <form:input path="contrasenia2" name="numero2" type="number" class="form-control"/>
